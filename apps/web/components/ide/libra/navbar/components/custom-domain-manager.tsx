...
export function CustomDomainManager({
  ...
  const dnsRecords: DNSRecord[] = [
    ...
    },
    {
      type: 'CNAME',
      name: domain,
      target: 'customers.forge.tmidev.net',
      status: status === 'active' ? 'active' : 'pending',
    },
  ]
    ...
    <div className='space-y-6'>
      ...
      <div className='space-y-3'>
        ...
        <div className='flex items-center gap-2 text-sm'>
          <span className='text-muted-foreground'>
            {m['ide.deployment.customDomain.visitYourDomain']()}
          </span>
          <a
            href={`https://${domain}`}
            target='_blank'
      ...
      <div className='space-y-4'>
        <h3 className='text-base font-medium'>
          {m['ide.deployment.customDomain.setFollowingRecords']()}
        </h3>
                  ...
                  <div className='grid grid-cols-3 gap-4 text-sm'>
                    <div>
                      <div className='text-muted-foreground mb-1'>
                        {m['ide.deployment.customDomain.type']()}
                      </div>
      ...
      {onRemove && (
        <div className='flex justify-end pt-4 border-t'>
          <Button variant='destructive' size='sm' onClick={onRemove} disabled={isLoading}>
